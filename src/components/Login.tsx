    ...
    <div className="min-h-screen bg-slate-900 flex flex-col justify-center py-4 sm:py-6 sm:px-6 lg:px-8 relative overflow-hidden" id="login-container">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md z-10">
        ...
        <div className="flex justify-center">
          <div className="w-28 h-32 sm:w-32 sm:h-36 flex items-center justify-center p-2">
            <img src="/logo.png" alt="71º BI Mtz Logo" className="w-full h-full object-contain filter drop-shadow-md" />
          </div>
        </div>
        
        <h2 className="mt-4 text-center text-3xl font-display font-medium tracking-tight text-white antialiased">
          CONTRATOS - 71º BI Mtz
        </h2>
        <p className="mt-1 text-center text-sm font-sans text-emerald-400 font-medium tracking-wide uppercase">
        ...
        <div className="bg-slate-800/90 border border-slate-700/80 backdrop-blur-md py-6 px-6 shadow-2xl rounded-xl sm:px-10" id="login-card">
          {!showRecover ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {error && (
                <div className="p-3 bg-red-950/80 border border-red-750 text-red-200 text-sm rounded-lg flex items-start gap-2 animate-shake">
              ...
              <div>
                <label className="block text-xs font-medium font-sans uppercase tracking-wider text-slate-300">
                  Usuário
                </label>
              ...
              <div className="flex items-center justify-between text-xs">
                <div className="flex items-center text-slate-400 font-mono gap-1.5">
            ...
            <form onSubmit={handleRecover} className="space-y-6">
              ...
              {recoverError && (
                <div className="p-3 bg-red-950/80 border border-red-750 text-red-200 text-sm rounded-lg">
                  {recoverError}
                </div>
              )}

              {recoverSuccess && (
                <div className="p-4 bg-emerald-950/90 border border-emerald-600 text-emerald-100 text-sm rounded-lg leading-relaxed">
                  <p className="font-semibold text-white mb-1">Registro Encontrado!</p>
                  <p>{recoverSuccess}</p>
                </div>
              )}
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2.5 border border-slate-700 bg-slate-900 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm text-center"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2.5 border border-slate-700 bg-slate-900 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm text-center font-mono"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <button
                  ...
                  className="text-xs font-semibold text-slate-400 hover:text-white transition-colors uppercase tracking-wider text-left"
                >
                  Voltar para o Login
                </button>
              </div>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full flex justify-center py-2.5 px-4 border border-emerald-500 rounded-lg text-sm font-semibold font-display tracking-wider text-white uppercase bg-emerald-850 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                >
                  Auditar e Recuperar
                </button>
              </div>
